...
if(loadContactMatrices)
{
  ...
  contacts <- contacts_china # normalize.contact.matrices(contacts_china,wuhanpop$popage, make.sym=T) # contacts_china
  rm(contacts_china)
}

# case age distribution
# age group is 10 years in the original data. Split each bin into equal halves to create 5-year bins
if(loadCaseData)
{
